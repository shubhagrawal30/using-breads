...
# dir_name = "/scr3/jruffio/data/osiris_survey/targets/HIP73049/210627/reduced/"
files = os.listdir(dir_name)

print("making subdirectories")
Path(dir_name+"spectra/").mkdir(parents=True, exist_ok=True)
...
for fil in files:
    ...
    _ = cal.telluric_calibration(data, star_spectrum, mask=True, verbose=True, calib_filename=dir_name+"spectra/"+fil[:-5]+"_spectrum.fits")
